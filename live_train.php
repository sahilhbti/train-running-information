...
<html>
<head>
	<title>Welcome to railway enquiry system(unofficial)-Train Status</title>
...
<body >
  ...
  <script>
   ...
   <h3 style="border-style: dotted;font-size: 30px;text-align: center;padding-top: 7px;padding-bottom: 7px;margin-top: 3px;"><i>Live Train Status</i></h3>
   <br>
   <form method="post" action="learn.php" style="background-color: rgb(183, 208, 208);margin-left: 40px;margin-right: 100px;  ">
     <fieldset >
     	<legend style="color: blue;"><b>Live Train Information</b></legend>
   	 <p style="margin-left: 240px"><b>Enter Train Number</b></p>
   	<input placeholder="12345" required type="text"  name="train_name" style="margin-left: 240px;font-size: 20px;" onkeypress="return isNumberKey(event)">
   	<button type="submit" style="margin-left: 10px;padding: 10px;border-radius: 50%;">Find</button>
   	<hr>
    <hr>
    <br>
