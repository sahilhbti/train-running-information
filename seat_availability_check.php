...
<html>
<head>
	<title>Welcome to railway enquiry system(unofficial)-seat availability</title>
	<style>
	.top
	{
...
<body>
     ...
     <?php 
       ...
       $GLOBALS['get_string'] = "https://api.railwayapi.com/v2/check-seat/train/".$_POST["train_number"]."/source/".$_POST["source_stn"]."/dest/".$_POST["dest_stn"]."/date/".$_POST["journey_date"]."/pref/".$_POST["class_name"]."/quota/".$_POST["quota_name"]."/apikey/zka0st3l0n/ ";
    ...
    <div class="header">
      ...
      <a href = " ">CANCELLED TRAIN</a>
      <a href = " ">DIVERTED TRAIN</a>
      <a href = " ">RESCHECULED TRAIN</a>
      <a href = "https://www.irctc.co.in/nget/">TICKET BOOKING</a>
   </div>  
     <h3 style="border-style: dotted;font-size: 30px;text-align: center;padding-top: 7px;padding-bottom: 7px;"><i>Seat Availability</i></h3>   
     ...
     <tr>
     	...
     	<td><b><?php echo $json[from_station][name];?></b></td>
     	<td><b><?php echo $json[to_station][name];?></b></td>
     	<td><b><?php echo $json[quota][name]?></b></td>
      <td><b><?php echo $json[journey_class][name]?></b></td>
     </tr> 
     </table>
     <br>
     <br>
     <table style="margin-left: 400px;">
      ...
      <th>Status</th>
        ...
        <?php foreach ($json[availability] as $character) : ?>
        <tr>
