...
<html>
<head>
	<title>Welcome to railway enquiry system(unofficial)-Rescheduled Trains</title>
	<style>
	.top
	{
...
<body>
      ...
      <a href = "cancelled.php">CANCELLED TRAINS</a>
      <a href = "rescheduled.php">RESCHECULED TRAINS</a>
   ...
   <h3 style="border-style: dotted;font-size: 30px;text-align: center;padding-top: 7px;padding-bottom: 7px;margin-top: 3px;"><i>Rescheculed Trains</i></h3>
   <br>
   <form style="background-color: rgb(183, 208, 208);" action="rescheduled_check.php" method="post">
   	<fieldset>
