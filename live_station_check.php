...
<html>
<head>
	<title>Welcome to railway enquiry system(unofficial)-checking live station</title>
	<style>
	.top
	{
...
<body>
   ...
   <br>
   <h2 style="margin-left: 80px;text-transform: uppercase;">LIST OF TRAIN ARRIVING AT <?php echo $_POST["station"] ?> WITHIN <?php echo $_POST["hours"]?> HOURS </h2>
   	<?php
	    	$GLOBALS['get_string'] = "https://api.railwayapi.com/v2/arrivals/station/".$_POST["station"]."/hours/".$_POST["hours"]."/apikey/zka0st3l0n/";
   ...
   <table style="margin-left: 50px;margin-right: 50px;">
   	  <tr>
   	   ...
   	   <?php foreach ($json[trains] as $character) : ?>
           ...
           <td> <?php echo $character[actarr]; ?> </td>
           <td> <?php echo $character[actdep]; ?> </td>
           <td> <?php echo $character[scharr]; ?> </td>
            <td> <?php echo $character[schdep]; ?> </td>
            <td> <?php echo $character[delayarr]; ?> </td>
            <td> <?php echo $character[delaydep]; ?> </td>
        </tr>
		<?php endforeach; ?> 
   </table>
   <div class="footer">
