...
<html>
<head>
	<title>Welcome to railway enquiry system(unofficial)-TRAIN ROUTE</title>
	<style>
		.top
	{
...
<body>
   ...
   <h3 style="border-style: dotted;font-size: 30px;text-align: center;padding-top: 7px;padding-bottom: 7px;margin-top: 3px;"><i>Train Route</i></h3>
   <br>
   <form  action="route_check.php" method="post" style="margin-left: 90px;background-color: rgb(183, 208, 208);margin-right: 30px;">
   	<fieldset>
   		<legend style="color: blue;"><b>Route</b></legend>
   		<br>
   	<b style="font-size: 25px;margin-left: 30px;">Enter the train Number </b>
   	<br>
   	<input onkeypress="return isNumberKey(event)" required type="text" name="train_number" style="margin-top: 30px;margin-left: 30px; padding-top: 6px;padding-bottom: 5px;font-size: 15px;">
   <input type="submit" value="Submit" style="border-radius: 50%;margin-left: 300px;padding: 10px;font-size: 15px;">
   </fieldset>
   </form>
     <br>
     <br>
...
<hr>
 <div class="footer">
    <p style = "text-align:center;color: white;padding-top: 20px;">INDIAN RAILWAY ENQUIRY SYSTEM</p>
         <p style=" text-align: center;color: white;margin-right: 20px;">MADE BY SAHIL SRIVASTAVA  </p>
